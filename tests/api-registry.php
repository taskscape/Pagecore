...
$expected = array('get', 'revisions', 'media-list', 'media-impact', 'content-inventory', 'version', 'preview-draft', 'preview', 'save', 'save-draft', 'publish', 'discard-draft', 'restore', 'save-post-meta', 'create-post', 'delete-post', 'delete-page', 'save-nav', 'create-region', 'save-media-meta', 'delete-media', 'upload', 'update-status', 'update-apply', 'logout');
sort($expected);
