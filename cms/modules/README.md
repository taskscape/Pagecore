...
- `path-policy.php` owns platform normalization and containment.
- `session-context.php` owns secure session startup and expiry and receives validated configuration and transport explicitly.
- `content-policy.php` owns pure visibility and collection rules.
